...
public class PizzaOpenItemActivity extends AppCompatActivity {
    ...
    DatabaseReference allItemsRef = FirebaseDatabase.getInstance().getReference().child("admin").child("all_items").child("pizzas");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(PizzaOpenItemActivity.this);
        ...
        back_button_openActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(PizzaOpenItemActivity.this, MainActivity2.class));
                finish();
            }
        });

        final int id = getIntent().getIntExtra("itemId", 1);
        Log.v("id in open", String.valueOf(id));
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                try {
                    if (item.getVersion() != null) {
                        ...
                        ArrayAdapter<String> vad = new ArrayAdapter<>(PizzaOpenItemActivity.this, android.R.layout.simple_spinner_dropdown_item, versionArray);
                ...
                try{
                    if (item.getWeight_in_pounds_or_qunatity() != null){
                        ...
                        ArrayAdapter<String> siad = new ArrayAdapter<>(PizzaOpenItemActivity.this, android.R.layout.simple_spinner_dropdown_item, weightArray);
                ...
                try{
                    if(item.getFlavour() != null){
                        ...
                        ArrayAdapter<String> flad = new ArrayAdapter<>(PizzaOpenItemActivity.this, android.R.layout.simple_spinner_dropdown_item, flavorArray);
                ...
                try{
                    if (item.getShape() != null){
                        ...
                        ArrayAdapter<String> shad = new ArrayAdapter<>(PizzaOpenItemActivity.this, android.R.layout.simple_spinner_dropdown_item, shapeArray);
        ...
        add_to_cart_openItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(PizzaOpenItemActivity.this, "Item Sucessfully Added", Toast.LENGTH_SHORT).show();
            }
        });
    }
}