...
public class PlantNBoquetOpenItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(PlantNBoquetOpenItemActivity.this);
        ...
        back_button_openActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(PlantNBoquetOpenItemActivity.this, MainActivity2.class));
                finish();
            }
        });
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                try {
                    if (item.getVersion() != null) {
                        ...
                        ArrayAdapter<String> vad = new ArrayAdapter<>(PlantNBoquetOpenItemActivity.this, android.R.layout.simple_spinner_dropdown_item, versionArray);
                ...
                try{
                    if (item.getWeight_in_pounds_or_qunatity() != null){
                        ...
                        ArrayAdapter<String> siad = new ArrayAdapter<>(PlantNBoquetOpenItemActivity.this, android.R.layout.simple_spinner_dropdown_item, weightArray);
                ...
                try{
                    if(item.getFlavour() != null){
                        ...
                        ArrayAdapter<String> flad = new ArrayAdapter<>(PlantNBoquetOpenItemActivity.this, android.R.layout.simple_spinner_dropdown_item, flavorArray);
                ...
                try{
                    if (item.getShape() != null){
                        ...
                        ArrayAdapter<String> shad = new ArrayAdapter<>(PlantNBoquetOpenItemActivity.this, android.R.layout.simple_spinner_dropdown_item, shapeArray);
        ...
        add_to_cart_openItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(PlantNBoquetOpenItemActivity.this, "Item Sucessfully Added", Toast.LENGTH_SHORT).show();
            }
        });
    }
}