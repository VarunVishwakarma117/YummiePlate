...
public class ListAdapter extends ArrayAdapter<com.vishwakarma.yummieplate.item> {
    ...
    public ListAdapter(Activity context, ArrayList<com.vishwakarma.yummieplate.item> al, boolean callByWishlist) {
        super(context, 0, al);
        this.callByWishlist = callByWishlist;
        Vibrator = (Vibrator)getContext().getSystemService(MainActivity.VIBRATOR_SERVICE);
    }
    public ListAdapter(Activity context, ArrayList<com.vishwakarma.yummieplate.item> al, boolean callByWishlist, int cate) {
        super(context, 0, al);
        this.callByWishlist = callByWishlist;
        Vibrator = (Vibrator)getContext().getSystemService(MainActivity.VIBRATOR_SERVICE);
        this.cate = cate;
